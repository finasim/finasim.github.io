...
export const certifications: Certification[] = [
  { name: "Salesforce Certified Platform Integration Architect", issuer: "Salesforce" },
  { name: "Salesforce Platform Developer II (PDII)", issuer: "Salesforce" },
  { name: "Salesforce Platform Developer I (PDI)", issuer: "Salesforce" },
